...
lower_limit = 21 # this is the lowest number of days that will be used to aggregate water deficit into SPEI
upper_limit = 270  # this is maximum number of days that will be used to aggregate water deficit into SPEI
...
ggsave(paste0("SPEI_example.png"), height = 7, width = 10)
